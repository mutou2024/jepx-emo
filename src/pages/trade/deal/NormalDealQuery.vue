<template>
  <div class="normal-deal-query" style="padding: 20px; background-color: #f5f7fa; min-height: 100vh;">
    <el-page-header 
      content="常规成交查询" 
    ...
    <el-card shadow="hover" style="max-width: 1200px;">
      ...
      <el-pagination
        ...
        :total="normalDealListView.list.length"
...
import { normalDealList } from '../../../mock/dealMock'
...
// 常规成交列表数据
const normalDealListView = ref(normalDealList)

// 查询操作
const handleQuery = () => {
  // 模拟查询过滤
  ElMessage.success('常规成交数据查询成功！')
